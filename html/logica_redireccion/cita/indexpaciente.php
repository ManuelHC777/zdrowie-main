        ...
        <div id="content-page" class="content-page">
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-3" id="nueva_cita">
                       ...
                       <button type="button" class="btn" data-toggle="modal" data-target="#exampleModalCenter" style="display: contents">
                           <div class="iq-card-body iq-bg-primary rounded">
                               <div class="d-flex align-items-center justify-content-between">
                                   <div class="rounded-circle iq-card-icon bg-primary"><i class="ri-add-fill"></i></div>
                                   <div class="mini-stat-info text-right">
                                        <h4 class="mb-0">Nueva cita</h4>
                                        <h6 style="color:#089bab ;">Primera Vez</h6>
                                   </div>
                               </div>
                           </div>
                       </button>
                           ...
                           <div class="iq-card-body iq-bg-primary rounded">
                               <div class="d-flex align-items-center justify-content-between">
                                   ...
                                   <div class="mini-stat-info text-right">
                                        ...
                                        <h6 style="color:#089bab ;">Total de Pacientes</h6>
                                   </div>
                               </div>
                           </div>
                       </div>
                                                ...
                                                <table id="tabla" class="table table-striped table-bordered">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>Calle Antigua a Ilobasco Cantón el
                                                                Copinol
                                                            </td>
                                                            <td align="center">
                                                                <div class="btn-group" role="group" aria-label="">
                                                                    <a href="#" id="registrar_cita"
                                                                        class="btn btn-success" type="button"
                                                                        data-toggle="modal"
                                                                        data-target="#ModalRegistrar"><i
                                                                            class="fi fi-rs-add"></i></a>
