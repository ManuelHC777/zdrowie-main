               ...
               <div class="col-md-6 col-lg-3">
                           ...
                           <div class="iq-card-body iq-bg-primary rounded">
                               <div class="d-flex align-items-center justify-content-between">
                                   ...
                                   <div class="mini-stat-info text-right">
                                        ...
                                        <h6 style="color:#089bab ;">Total de Usuarios</h6>
                                   </div>
                               </div>
                           </div>
                       </div>
                       ...
                       <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                           <div class="iq-card-body iq-bg-primary rounded">
                               <div class="d-flex align-items-center justify-content-between">
                                   ...
                                   <div class="mini-stat-info text-right">
                                        <h4 class="mb-0"><span class="counter">1</span></h4>
                                        <h6 style="color:#089bab ;">Administradores</h6>
                                   </div>
                               </div>
                           </div>
                       </div>
                   ...
                   <div class="col-md-6 col-lg-3">
                       <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                           <div class="iq-card-body iq-bg-primary rounded">
                               <div class="d-flex align-items-center justify-content-between">
                                   <div class="rounded-circle iq-card-icon bg-primary"><i class="healthicons-doctor"></i></div>
                                   
                                   <div class="mini-stat-info text-right">
                                        <h4 class="mb-0"><span class="counter">2</span></h4>
                                        <h6 style="color:#089bab ;">Doctores</h6>
                                   </div>
                               </div>
                           </div>
                       </div>
                              ...
                              <table id="data" class="table table-striped table-bordered" >
                                 ...
                                 <tbody>
                                    ...
                                    <tr>
                                       ...
                                       <td align="center">
                                       <button type="button" class="btn btn-primary mb-3" data-toggle="modal" data-target="#exampleModalCenter2"><i class="fa fa-pencil"></i></button>
                                       <button type="button" class="btn btn-danger mb-3"><i class="fa fa-trash"></i></button>
                                       </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                       ...
                                       <td>Doctor</td>
                                        ...
                                        <td align="center">
                                            <button type="button" class="btn btn-primary mb-3"><i class="fa fa-pencil" data-toggle="modal" data-target="#exampleModalCenter2"></i></button>
                                            <button type="button" class="btn btn-danger mb-3"><i class="fa fa-trash"></i></button>
                                        </td>
                                          ...
                                          <form>
                                             <div class="form-row">
                                                <div class="col-md-6 mb-3">
                                                   <label>Nombre</label>
                                                   <input type="text" autocomplete="off"  placeholder="Ingrese los nombres" name="validationDefault01" class="form-control" id="validationDefault01" required value="Manuel Herrera" disabled>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                   <label>Usuario</label>
