                              ...
                              <div class="iq-card shadow-none m-0">
                                 <div class="iq-card-body p-0 ">
                                    <div class="bg-primary p-3">
                                       <h5 class="mb-0 text-white line-height">Hola Administrador</h5>
                                    ...
                                    <a href="profile.html" class="iq-sub-card iq-bg-primary-hover">
                                       <div class="media align-items-center">
                                          ...
                                          <div class="media-body ml-3">
                                             ...
                                             <p class="mb-0 font-size-12">Ver detalles de perfil.</p>
                                          </div>
                                       </div>
                                    </a>
                                     <a href="profile-edit.html" class="iq-sub-card iq-bg-primary-hover">
                                       <div class="media align-items-center">
                                          ...
                                          <div class="media-body ml-3">
                                             <h6 class="mb-0 ">Recuperar Contraseña</h6>
                                             <p class="mb-0 font-size-12">Restalecer credencial de acceso al sistema.</p>
                                          </div>
                                       </div>
                                    </a>
                                    ...
                                    <a href="privacy-setting.html" class="iq-sub-card iq-bg-primary-hover">
                                       <div class="media align-items-center">
                                          ...
                                          <div class="media-body ml-3">
                                             ...
                                             <p class="mb-0 font-size-12">Asegura el acceso al sistema mientras no lo usas.</p>
                                          </div>
                                       </div>
                                    </a>
            ...
            <div class="container-alt container">
               ...
               <div class="col-12 text-center">
                  <h1>Bienvenido al Sistema</h1>
                       <img src="../../images/cares.png" class="img-fluid" alt="">
