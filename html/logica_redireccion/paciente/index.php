                     ...
                     <div class="iq-card-body iq-bg-primary rounded">
                        <div class="d-flex align-items-center justify-content-between">
                           ...
                           <div class="mini-stat-info text-right">
                              ...
                              <h6 style="color:#089bab ;">En espera</h6>
                           </div>
                                             ...
                                             <td>
                                                <div class="dropdown m-b-10">
                                                   ...
                                                   <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                      <a class="dropdown-item btn_editar" href="javascript:void(0)" data-toggle="modal" data-target="#exampleModalCenter">Aperturar</a>
                                                      <a class="dropdown-item btn_eliminar" href="javascript:void(0)">Eliminar</a>
                                                   </div>
                                             </td>
                                          </tr>
                                          <tr>
                        ...
                        <form>
                           <div class="form-row">
                              <div class="col-md-6 mb-3">
                                 <label>Nombres</label>
                                 <input type="text" autocomplete="off" value="Juan Carlos" name="nombre" class="form-control" id="nombre" disabled>
                              </div>
                              <div class="col-md-6 mb-3">
                                 <label>Apellidos</label>
                                 <input type="text" autocomplete="off" name="apellido" value="De Leon Cruz" class="form-control" id="nombre" disabled>
                              </div>
                              ...
                              <div class="col-md-4 mb-3">
                                 ...
                                 <input type="text" autocomplete="off" value="7478-0098" data-mask="9999-9999" placeholder="No.telefono" name="telefono" id="telefono" class="form-control" disabled>
                              </div>
